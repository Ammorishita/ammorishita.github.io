...
let app = {
    init: function() {
        ...
        window.requestAnimationFrame(this.playerSlide.bind(this));
    ...
    playerSlide: function() {
        if(app.gamma <= -5 && app.gamma >= -20) {
            app.direction = 'left';
            console.log('app.gamma left');
        } else if (app.gamma > 5 && app.gamma <= 20) {
            app.direction = 'right';
            console.log('app.gamma right');
        } else if (app.gamma <= 5 && app.gamma > -4) {
            app.direction = 'straight';
            console.log('gamma straight');
        }
        player.slide(app.direction);
    },
